 ...
 * @author ErIcK
 */
public class VntModificaPaciente extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jLabel8.setText("Selecciona el paciente que deseas modificar");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jtVigencia, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    {//GEN-HEADEREND:event_btnAceptarActionPerformed
        ...
        if (MnpHDEP.verificarNoDuplicadosDePaciente(jcDependencia.getSelectedItem().toString(), jcHospital.getSelectedItem().toString(), jcEspecialidad.getSelectedItem().toString(), jtNombre.getText().toLowerCase().trim()) && !jtNombre.getText().equals(jcPaciente.getSelectedItem().toString()))
        {
        ...
        NodoML n = MnpHDEP.buscarPaciente(dependencia, hospital, especialidad, paciente);

        if (n != null)
        {

            codigo.MnpHDEP.modificarPaciente(n, nombre, vigencia, status, sexo);
        ...
        if (aux != null)
        {
            JOptionPane.showMessageDialog(this, "HOSPITAL EN REMODELACIÓN, CAMBIOS HECHOS EN HOSPITAL TEMPORAL: " + aux.getEtiqueta() + "\n" + "El paciente fue actualizado con el nombre: " + nombre + "\n" + "Vigencia: " + vigencia + "\n" + "Status: " + status + "\n" + "Sexo: " + sexo, "Modificar paciente", JOptionPane.INFORMATION_MESSAGE);
        } else
        {
            JOptionPane.showMessageDialog(this, "El paciente fue actualizado con el nombre: " + nombre + "\n" + "Vigencia: " + vigencia + "\n" + "Status: " + status + "\n" + "Sexo: " + sexo, "Modificar paciente", JOptionPane.INFORMATION_MESSAGE);
        }

        CtrlInterfaz.limpia(jtNombre, jtVigencia);
        CtrlInterfaz.habilita(false, jcEspecialidad, jtVigencia, jtNombre, jcHospital, btnAceptar, jcPaciente, jcSexo, jcStatus);
        //validacion
    ...
    {//GEN-HEADEREND:event_jtNombreKeyPressed
        if (evt.getKeyChar() == '\n' && MnpHDEP.verificarNoDuplicadosDePaciente(jcDependencia.getSelectedItem().toString(), jcHospital.getSelectedItem().toString(), jcEspecialidad.getSelectedItem().toString(), jtNombre.getText().toLowerCase().trim()) && !jtNombre.getText().equals(jcPaciente.getSelectedItem().toString()))
        {
...
//        if (evt.getKeyChar() == '\n')
//        {
//            jtVigencia.setEnabled(true);
//            jtVigencia.requestFocus();
//        }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VntModificaPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VntModificaPaciente().setVisible(true);
            }
        });
    }
