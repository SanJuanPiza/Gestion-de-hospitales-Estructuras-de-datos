 ...
 * @author Cristo
 */
public class VntSubirTerNivel extends javax.swing.JFrame
{

    /**
     * Creates new form VntBajaHospital
     */
    public VntSubirTerNivel()
    {
        initComponents();
        try
        {
            jcDependencia.setModel(new javax.swing.DefaultComboBoxModel<>(codigo.MnpHDEP.mostrarDependenciasStCmbox()));
            jcHospital.setModel(new javax.swing.DefaultComboBoxModel<>(codigo.MnpHDEP.mostrarHospitalesSinTercerNivel(jcDependencia.getSelectedItem().toString())));
            ...
            jcDependencia.addActionListener(new java.awt.event.ActionListener()
            {
                ...
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
                    ...
                    jcHospital.setModel(new javax.swing.DefaultComboBoxModel<>(
                            codigo.MnpHDEP.mostrarHospitalesSinTercerNivel(dependenciaSeleccionada)
                    ));
                }
            });
        } catch (Exception e)
    ...
    private void initComponents()
    {
        ...
        setTitle("Subir a tercer nivel");
        setType(java.awt.Window.Type.UTILITY);

        jLabel1.setText("Selecciona la dependencia a la que pertenece el hospital que quieres subir a tercer nivel");
        ...
        jLabel2.setText("Selecciona el hospital que deseas subir de nivel");
    ...
    {//GEN-HEADEREND:event_btnAceptarActionPerformed
        ...
        if (jcDependencia.getSelectedItem().toString().equals("Sin dependencias registradas") || jcHospital.getSelectedItem().toString().equals("Sin hospitales registrados con nivel menor a 3"))
        {
        ...
        if (aux != null)
        {
            ...
            MnpHDEP.subirTercerNivel(dependencia, hospital);
           

            JOptionPane.showMessageDialog(this, "HOSPITAL EN REMODELACIÓN, CAMBIOS HECHOS EN HOSPITAL TEMPORAL: " + aux.getEtiqueta() + "\n" + "El hospital " + hospital + " fue subido a tercer nivel con exito", "Tercer nivel", JOptionPane.INFORMATION_MESSAGE);
        } else
        {
            MnpHDEP.subirTercerNivel(dependencia, hospital);
            JOptionPane.showMessageDialog(this, "El hospital " + hospital + " fue subido a tercer nivel con exito", "Tercer nivel", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    {//GEN-HEADEREND:event_jcHospitalKeyPressed
        if (jcHospital.getSelectedItem().toString().equals("Sin hospitales registrados con nivel menor a 3") && evt.getKeyChar() == '\n')
        {
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VntSubirTerNivel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VntSubirTerNivel().setVisible(true);
            }
        });
    }
