 ...
 * @author Cristo
 */
public class VntAltaaPaciente extends javax.swing.JFrame
{

    /**
     * Creates new form VntBajaEspecialidad
     */
    public VntAltaaPaciente()
    {
        initComponents();
        try
        {
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Selecciona la dependencia a la que pertenece la especialidad que quieres dar de alta");

        jLabel2.setText("Selecciona el hospital a la que pertenece el paciente que deseas dar de alta");
        ...
        jLabel3.setText("Selecciona la especialidad a la que pertenece el paciente que quieres dar de alta");
        ...
        jLabel4.setText("Selecciona el paciente que deseas dar de alta");
...
//            ManipulaArchivos.guardaBicola(MnpHDEP.bicola, "Bicola.dat");
            ...
            if (aux != null)
            {
                vbc = MnpHDEP.darAltaPaciente(dependencia, aux.getObj().getNombre(), especialidad, paciente);
                JOptionPane.showMessageDialog(this, "HOSPITAL EN REMODELACIÓN, CAMBIOS HECHOS EN HOSPITAL TEMPORAL: " + aux.getEtiqueta() + "\n" + "El paciente " + paciente + " obtuvo su alta de la especialidad: " + especialidad + " en hospital: " + hospital, "Alta de paciente", JOptionPane.INFORMATION_MESSAGE);
            } else
            {
                vbc = MnpHDEP.darAltaPaciente(dependencia, hospital, especialidad, paciente);
                JOptionPane.showMessageDialog(this, "El paciente " + paciente + " obtuvo su alta de la especialidad: " + especialidad + " en hospital: " + hospital, "Alta de paciente", JOptionPane.INFORMATION_MESSAGE);
            }
            if (vbc != null)
            {
                JOptionPane.showMessageDialog(this, "El paciente " + vbc.getObj().getNombre() + " se ingreso a una cama de: " + especialidad + " en hospital: " + hospital, "Ingreso de paciente", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VntAltaaPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VntAltaaPaciente().setVisible(true);
            }
        });
    }
