 ...
 * @author Cristo
 */
public class VntBajaEspecialidad extends javax.swing.JFrame
{

    /**
     * Creates new form VntBajaEspecialidad
     */
    public VntBajaEspecialidad()
    {
        initComponents();
        try
        {
    ...
    private void initComponents()
    {
        ...
        jLabel2.setText("Selecciona el hospital a la que pertenece la especialidad que deseas dar de baja");
        ...
        jLabel3.setText("Selecciona la especialidad que quieres dar de baja");
    ...
    {//GEN-HEADEREND:event_btnAceptarActionPerformed
        ...
        if (jcDependencia.getSelectedItem().toString().equals("Sin dependencias registradas") || jcHospital.getSelectedItem().toString().equals("Sin hospitales registrados") || jcEspecialidad.getSelectedItem().toString().equals("Sin especialidades registradas"))
        {
        ...
        String especialidad = jcEspecialidad.getSelectedItem().toString().toLowerCase();

        if (especialidad.equals("oncología") || especialidad.equals("oncologia") || especialidad.equals("neurocirugia") || especialidad.equals("neurocirugía"))
        {
            JOptionPane.showMessageDialog(this, "La especialidad: " + especialidad + " no puede ser dada de baja a menos que bajes el hospital de tercer nivel ", "Baja especialidad", JOptionPane.WARNING_MESSAGE);
            return;
        }
        especialidad = jcEspecialidad.getSelectedItem().toString();
        ...
        if (aux != null)
        {
            ...
            codigo.MnpHDEP.bajaEspecialidad(dependencia, hospital, especialidad);
            JOptionPane.showMessageDialog(this, "HOSPITAL EN REMODELACIÓN, CAMBIOS HECHOS EN HOSPITAL TEMPORAL: " + aux.getEtiqueta() + "\n" + "La especialidad: " + especialidad + " fue dada de baja correctamente", "Baja especialidad", JOptionPane.INFORMATION_MESSAGE);
        } else
        {
            codigo.MnpHDEP.bajaEspecialidad(dependencia, hospital, especialidad);
            JOptionPane.showMessageDialog(this, "La especialidad: " + especialidad + " fue dada de baja correctamente", "Baja especialidad", JOptionPane.INFORMATION_MESSAGE);
        }

        CtrlInterfaz.habilita(false, jcHospital, jcEspecialidad, btnAceptar);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VntBajaEspecialidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VntBajaEspecialidad().setVisible(true);
            }
        });
    }
